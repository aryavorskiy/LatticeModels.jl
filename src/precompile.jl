...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:statistics,), Tuple{ParticleStatistics}},typeof(densitymatrix),Eigensystem{LatticeBasis{SquareLattice{2}}, Matrix{ComplexF64}}})   # time: 0.5440749
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:statistics,), Tuple{ParticleStatistics}},typeof(densitymatrix),HamiltonianEigensystem{LatticeBasis{HoneycombLattice}, Matrix{ComplexF64}, FilledZones{Sample{Nothing, HoneycombLattice, Nothing, BoundaryConditions{Tuple{}}}}}})   # time: 0.1134332
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:field,), Tuple{NoField}},typeof(build_operator!),SparseMatrixBuilder{ComplexF64},Sample{Nothing, HoneycombLattice, Nothing, BoundaryConditions{Tuple{}}},Pair{Int64, Bonds{Pair{Int64, Int64}, 0}}})   # time: 0.069698
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:field,), Tuple{LandauField}},typeof(build_hamiltonian),Sample{Nothing, SquareLattice{2}, Nothing, BoundaryConditions{Tuple{}}},Bonds{Nothing, 1},Bonds{Nothing, 2}})   # time: 0.0500347
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:pade, :k), Tuple{Bool, Int64}},typeof(_evolution_block),Expr,Expr})   # time: 0.046688
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:inner,), Tuple{LatticeSite{2}}},typeof(getindex),TimeSequence{LatticeValue}})   # time: 0.0387804
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:axis,), Tuple{Int64}},Type{SiteOffset}})   # time: 0.0364859
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:field,), Tuple{LandauField}},typeof(hoppings),SquareLattice{2},Bonds{Nothing, 1},Bonds{Nothing, 2}})   # time: 0.0346634
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:field,), Tuple{NoField}},typeof(build_operator!),SparseMatrixBuilder{ComplexF64},Sample{Nothing, HoneycombLattice, Nothing, BoundaryConditions{Tuple{}}},Pair{Int64, Bonds{Pair{Int64, Int64}, 2}}})   # time: 0.0313764
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:inner,), Tuple{LatticeValue{Bool, SquareLattice{2}}}},typeof(getindex),TimeSequence{LatticeValue}})   # time: 0.0298848
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:field,), Tuple{NoField}},typeof(build_operator!),SparseMatrixBuilder{ComplexF64},Sample{Nothing, HoneycombLattice, Nothing, BoundaryConditions{Tuple{}}},Pair{Complex{Int64}, Bonds{Pair{Int64, Int64}, 1}}})   # time: 0.0251329
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:field,), Tuple{LandauField}},typeof(qwz),SquareLattice{2}})   # time: 0.0184624
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:x, :x2), Tuple{Int64, Int64}},typeof(getindex),LatticeValue{Float64, SquareLattice{2}}})   # time: 0.01655
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:field,), Tuple{NoField}},typeof(build_operator!),SparseMatrixBuilder{ComplexF64},Sample{Nothing, HoneycombLattice, Nothing, BoundaryConditions{Tuple{}}},Pair{Int64, Bonds{Pair{Int64, Int64}, 1}}})   # time: 0.0125421
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:field,), Tuple{LandauField}},typeof(build_operator!),SparseMatrixBuilder{ComplexF64},Sample,Pair{SparseMatrixCSC{ComplexF64, Int64}, LatticeValue{Int64, SquareLattice{2}}}})   # time: 0.0077959
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:x1,), Tuple{Int64}},typeof(Base.Broadcast.dotview),LatticeValue{Float64, SquareLattice{2}}})   # time: 0.0071917
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:field,), Tuple{NoField}},typeof(build_operator!),SparseMatrixBuilder{ComplexF64},Sample{Nothing, HoneycombLattice, Nothing, BoundaryConditions{Tuple{}}},Pair{Complex{Int64}, Bonds{Pair{Int64, Int64}, 2}}})   # time: 0.0067972
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:k,), Tuple{Int64}},typeof(_evolution_block),Expr,Expr})   # time: 0.0016916
    ...
    Base.precompile(Tuple{typeof(Core.kwcall),NamedTuple{(:μ, :statistics), Tuple{Int64, ParticleStatistics}},Type{System},Sample{Nothing, SquareLattice{2}, Nothing, BoundaryConditions{Tuple{}}}})   # time: 0.001559
