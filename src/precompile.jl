...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(site_distance),BravaisLattice,BravaisSite,BravaisSite})   # time: 0.6472142
    ...
    Base.precompile(Tuple{typeof(RecipesBase.apply_recipe),AbstractDict{Symbol, Any},BravaisLattice,Any})   # time: 0.1854825
    Base.precompile(Tuple{typeof(shift_site),PeriodicBoundaryConditions,SquareLattice{2},BravaisPointer{2}})   # time: 0.1829159
    ...
    Base.precompile(Tuple{typeof(-),Currents,Currents})   # time: 0.0405042
    Base.precompile(Tuple{typeof(add_hopping_term!),SparseMatrixBuilder{ComplexF64},Nothing,SquareLattice{2},SparseMatrixCSC{ComplexF64, Int64},Bonds{Nothing, 1},LandauField,BoundaryConditions{Tuple{}}})   # time: 0.0390868
    ...
    Base.precompile(Tuple{typeof(RecipesBase.apply_recipe),AbstractDict{Symbol, Any},LatticeValue{<:Number, <:BravaisLattice{:square}}})   # time: 0.0364986
    Base.precompile(Tuple{typeof(iterate),BravaisSite{2}})   # time: 0.0362646
    ...
    Base.precompile(Tuple{typeof(site_index),SquareLattice{2},BravaisSite{2}})   # time: 0.0305971
    ...
    Base.precompile(Tuple{typeof(copyto!),LatticeValue{Int64, _A} where _A<:BravaisLattice,Base.Broadcast.Broadcasted{LatticeStyle, Tuple{Base.OneTo{Int64}}, typeof(+), Tuple{Int64, Base.Broadcast.Broadcasted{LatticeStyle, Nothing, typeof(*), Tuple{Base.Broadcast.Broadcasted{LatticeStyle, Nothing, typeof(<=), Tuple{Base.Broadcast.Broadcasted{LatticeStyle, Nothing, typeof(sqrt), Tuple{Base.Broadcast.Broadcasted{LatticeStyle, Nothing, typeof(+), Tuple{Base.Broadcast.Broadcasted{LatticeStyle, Nothing, typeof(Base.literal_pow), Tuple{Base.RefValue{typeof(^)}, LatticeValue{Float64, SquareLattice{2}}, Base.RefValue{Val{2}}}}, Base.Broadcast.Broadcasted{LatticeStyle, Nothing, typeof(Base.literal_pow), Tuple{Base.RefValue{typeof(^)}, LatticeValue{Float64, SquareLattice{2}}, Base.RefValue{Val{2}}}}}}}}, Int64}}, Int64}}}}})   # time: 0.0224039
    ...
    Base.precompile(Tuple{typeof(==),BravaisPointer{2},BravaisPointer{2}})   # time: 0.0175775
    Base.precompile(Tuple{typeof(*),Int64,Currents})   # time: 0.0175421
    ...
    Base.precompile(Tuple{typeof(collect_coords),BravaisLattice{:plot_fallback, 2, 1}})   # time: 0.0150389
    Base.precompile(Tuple{typeof(add_hopping_term!),SparseMatrixBuilder{ComplexF64},Nothing,SquareLattice{2},SparseMatrixCSC{Float64, Int64},Bonds{Nothing, 2},LandauField,BoundaryConditions{Tuple{}}})   # time: 0.0145549
    ...
    Base.precompile(Tuple{typeof(getproperty),BravaisSite{2},Symbol})   # time: 0.0110878
    ...
    Base.precompile(Tuple{typeof(getproperty),BravaisSite{3},Symbol})   # time: 0.0099567
    ...
    Base.precompile(Tuple{Type{Currents},SquareLattice{2}})   # time: 0.009332
    Base.precompile(Tuple{typeof(cartesian_index),BravaisPointer{2}})   # time: 0.0091336
    ...
    Base.precompile(Tuple{typeof(==),BravaisSite{2},BravaisSite{2}})   # time: 0.0080277
    Base.precompile(Tuple{typeof(add_diagonal_term!),SparseMatrixBuilder{ComplexF64},SparseMatrixCSC{ComplexF64, Int64},Vector{Float64}})   # time: 0.0080007
    ...
    Base.precompile(Tuple{typeof(add_diagonal_term!),SparseMatrixBuilder{ComplexF64},SparseMatrixCSC{Int64, Int64},Vector{Float64}})   # time: 0.0078389
    ...
    Base.precompile(Tuple{typeof(getindex),Currents,LatticeValue{Bool, SquareLattice{2}}})   # time: 0.0064549
    Base.precompile(Tuple{typeof(shift_site),BoundaryConditions{Tuple{TwistedBoundary}},SquareLattice{2},BravaisPointer{2}})   # time: 0.0064271
    ...
    Base.precompile(Tuple{typeof(==),BravaisSite{2},BravaisPointer{2}})   # time: 0.0057562
    Base.precompile(Tuple{typeof(add_assuming_zeros),SVector{2, Int64},SVector{1, Int64}})   # time: 0.0055314
    Base.precompile(Tuple{typeof(get_site_periodic),SquareLattice{2},BravaisPointer{2}})   # time: 0.0054188
    Base.precompile(Tuple{typeof(getproperty),BravaisSite,Symbol})   # time: 0.0053374
    Base.precompile(Tuple{typeof(add_hopping_term!),SparseMatrixBuilder{ComplexF64},Nothing,SquareLattice{2},SparseMatrixCSC{ComplexF64, Int64},Bonds{Nothing, 2},NoField,BoundaryConditions{Tuple{}}})   # time: 0.005279
    ...
    Base.precompile(Tuple{typeof(add_hopping_term!),SparseMatrixBuilder{ComplexF64},Function,SquareLattice{2},Int64,Pair{BravaisSite{2}, BravaisSite{2}},NoField,BoundaryConditions{Tuple{}}})   # time: 0.00433
    ...
    Base.precompile(Tuple{typeof(==),LatticeValue{T, LT} where {T, LT<:BravaisLattice},LatticeValue{Float64, SquareLattice{2}}})   # time: 0.0037912
    ...
    Base.precompile(Tuple{Type{BravaisLattice},Symbol,Tuple{Int64, Int64},UnitCell{2, 2}})   # time: 0.0028248
    ...
    Base.precompile(Tuple{Type{BravaisLattice},Symbol,Tuple{Int64, Int64, Int64},UnitCell{3, 1}})   # time: 0.0021363
    ...
    Base.precompile(Tuple{Type{BravaisLattice},Symbol,Tuple{Int64, Int64},UnitCell{2, 1}})   # time: 0.0020588
    Base.precompile(Tuple{Type{SquareLattice},Int64,Int64})   # time: 0.002001
    Base.precompile(Tuple{typeof(match),AdjacencyMatrix{SquareLattice{2}},BravaisSite{2},BravaisSite{2}})   # time: 0.0019427
    ...
    Base.precompile(Tuple{typeof(iterate),BravaisSite{2},Int64})   # time: 0.0010019
end
